...
import ru.sberbank.denisov26.javacard.repository.FullNameRepository;
...
public class SpringRestApplication implements CommandLineRunner {
    ...
    final FullNameRepository fullNameRepository;
    final ClientRepository clientRepository;

    public SpringRestApplication(FullNameRepository fullNameRepository, ClientRepository clientRepository) {
    ...
    public void run(String... args) throws Exception {
        ...
        Client alena = new Client(new Person("Alena", "Denisova", "Ivanovna", LocalDate.of(2012, 03, 06)),
        ...
        Client nikita = new Client(new Person("Nikita", "Denisov", "Ivanovich", LocalDate.of(2010, 02, 01)),
                ...
                Arrays.asList(new Card()));
        Client ekaterina = new Client(new Person("Ekaterina", "Bahareva", "Alexandrovna", LocalDate.of(2002, 10, 26)),
